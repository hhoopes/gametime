let paddle = class Paddle {
  ...
  move() {
    ...
    if (this.player === 1) {
      if (this.rightPressed) {
        this.dx = 9;
        this.dy = -9;
        if (this.x > this.oneThirdWidth - this.paddleWidth / 2 && !this.vertical) {
          this.vertical = true;
          this.x = this.oneThirdWidth;
          this.y = this.oneThirdWidth - this.paddleWidth / 2;
        ...
        this.dx = -9;
        this.dy = 9;
        // remove / 2 for tighter corners
        if (this.y > this.oneThirdWidth - this.paddleWidth / 2 && this.vertical) {
          this.vertical = false;
          this.x = this.oneThirdWidth - this.paddleWidth / 2;
          this. y = this.setPaddleY();
        } else if (this.vertical) {
          this.y += 9;
        } else if (!this.vertical) {
      ...
      if (this.rightPressed && this.x < this.canvas - this.paddleWidth) {
        ...
        this.dy = 9;
        // remove / 2 for tighter corners
        if (this.y > this.setPaddleY() - this.paddleWidth / 2 && this.vertical) {
          this.vertical = false;
          this.x = this.oneThirdWidth * 2 - this.paddleWidth / 2;
          this.y = this.setPaddleY();
        } else if (this.vertical) {
          this.y += 9;
        } else if (!this.vertical) {
        ...
        this.dx = -9;
        this.dy = -9;
        // remove '- this.paddleWidth / 2' for tighter corners
        if (this.x < this.oneThirdWidth * 2 - this.paddleWidth / 2) {
          this.vertical = true;
          this.x = this.oneThirdWidth * 2 - this.paddleHeight;
          this.y = this.setPaddleY() - this.paddleWidth / 2;
        } else if (this.vertical && this.y > 0) {
          this.y -= 9;
        } else if (!this.vertical) {
          this.x -= 9;
      ...
      if (this.rightPressed) {
        ...
        if (this.x > this.oneThirdWidth - this.paddleWidth / 2 && !this.vertical) {
          this.vertical = true;
          this.x = this.oneThirdWidth;
          this.y = this.oneThirdHeight * 2 - this.paddleWidth / 2;
        ...
        this.dx = -9;
        this.dy = -9;
        if (this.y < this.oneThirdHeight * 2 - this.paddleWidth / 2) {
          this.x = this.oneThirdWidth - this.paddleWidth / 2;
          this.y = this.oneThirdHeight * 2 - this.paddleHeight;
          this.vertical = false;
        } else if (this.vertical) {
          this.y -= 9;
        } else if (!this.vertical) {
      ...
      if (this.rightPressed && this.x < this.canvas - this.paddleWidth) {
        this.dx = 9;
        this.dy = -9;
        if (this.y < this.oneThirdWidth * 2 - this.paddleWidth / 2) {
          this.x = this.oneThirdWidth * 2 - this.paddleWidth / 2;
          this.y = this.setPaddleY();
          this.vertical = false;
        } else if (this.vertical) {
  ...
  setPaddleY() {
    if (this.player === 1 || this.player === 2) {
      ...
      return ((this.canvas / 3) * 2) - this.paddleHeight;
    }
  }
