...
let game = class Game {
  ...
  createGrid(){
    ...
    this.players.push(new Player(1, 0, 0, playerSpace));
    this.players.push(new Player(2, canvasSize - playerSpace, 0, playerSpace));
    this.players.push(new Player(3, 0, canvasSize - playerSpace, playerSpace));
    this.players.push(new Player(4, canvasSize - playerSpace, canvasSize - playerSpace, playerSpace));
